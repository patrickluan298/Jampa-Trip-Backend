docker-dev-up: # Inicia os containers em background
	docker-compose -f deployments/docker-compose.desenvolvimento.yaml up -d
...
docker-dev-logs: # Exibe logs em tempo real
	docker-compose -f deployments/docker-compose.desenvolvimento.yaml logs -f --tail=100
...
docker-dev-stop: # Para containers sem removê-los
	docker-compose -f deployments/docker-compose.desenvolvimento.yaml stop

docker-dev-down: # Para e remove containers/volumes
	docker-compose -f deployments/docker-compose.desenvolvimento.yaml down